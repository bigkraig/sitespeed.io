...
var cli = nomnom.help(
	...
	customScripts: {
		help: 'The path to an extra script folder with scripts that will be executed in the browser. See http://www.sitespeed.io/documentation/browsers/#custom-metrics'
	},
	seleniumServer: {
		metavar: 'URL',
	...
	boxes: {
		metavar: '<box1,box2>',
		list: true,
		help: 'The boxes showed on site summary page, see http://www.sitespeed.io/documentation/configuration/#configure-boxes-on-summary-page'
	},
	columns: {
		abbr: 'c',
		metavar: '<column1,column2>',
		list: true,
		help: 'The columns showed on detailed page summary table, see http://www.sitespeed.io/documentation/configuration/#configure-columns-on-pages-page'
	},
	configFile: {
		metavar: '<PATH>',
	...
	opentsdbHost: {
		metavar: '<HOST>',
		help: 'The OpenTSDB host.'
	},
	opentsdbPort: {
		metavar: '<INTEGER>',
		default: defaultConfig.opentsdbPort,
		help: 'The OpenTSDB port.'
	},
	opentsdbNamespace: {
		metavar: '<NAMESPACE>',
		default: defaultConfig.opentsdbNamespace,
		help: 'The namespace of the data sent to OpenTSDB.'
	},
	opentsdbData: {
		default: defaultConfig.opentsdbData,
		help: 'Choose which data to send to OpenTSDB by a comma separated list. Default all data is sent. [summary,rules,pagemetrics,timings,requests]'
	},
	gpsiKey: {
